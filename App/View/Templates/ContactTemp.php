        ...
        <tr>
            <td><h3> Contact info:</h3>
                <ul>
                    ...
                    <li>117, Olaines 4, Riga</li>
                    <li>LV 1055</li>
                    <li>Tel: +371 25446534</li>
                    <li>Email: aruna.wijewardana@gmail.com</li>
                </ul>
                <ul>
                    
                    <li>Karlis Geidans</li>
                    <li>Rupniecibas 21/3</li>
                    <li>LV 1058</li>
                    <li>Tel: +371 266 366 01</li>
                    <li>Email: kaksors@inbox.lv</li>
                </ul>
                <ul>
                    <li>Mikelis Gulbis</li>
                    <li>Lapu iela 11-2, Ogre</li>
                    <li>LV 5001</li>
                    <li>Tel: +371 26537965</li>
                    <li>Email: mikelis.gulbis@gmail.com</li>
                </ul>
            </td>
        </tr>
        </div>
